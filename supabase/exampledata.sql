...
BEGIN
    ...
    INSERT INTO thresholds (shelter_id, temp_warning, temp_critical, vibration_warning, vibration_critical, humidity_warning, humidity_critical)
    VALUES (v_shelter_id, 35.0, 40.0, 10.0, 20.0, 80.0, 90.0);
