...
import { mockAlerts, mockUser } from '@/data/mockData'
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between bg-surface-950/90 px-6 backdrop-blur-2xl shadow-sm shadow-surface-800/10">
      ...
      <div className="flex items-center gap-3">
        ...
        {/* User */}
        <button className="flex items-center gap-2 rounded-lg px-2 py-1.5 transition-colors hover:bg-surface-800/60">
